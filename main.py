...
def carregar_arquivos_para_s3(arquivos: List[str]) -> None:
    """Faz o envio dos arquivos listados para o S3."""
...
def deletar_arquivos_locais(arquivos: List[str]) -> None:
    """Deleta os arquivos locais após o envio para o S3."""
    for arquivo in arquivos:
        os.remove(arquivo)
...
def executar_backup(pasta: str) -> None:
    ...
    if arquivos:
        carregar_arquivos_para_s3(arquivos)
